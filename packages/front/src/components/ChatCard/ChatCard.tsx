...
export const ChatCard = ({ contactName }: { contactName: string }) => {
  return (
    <div className="w-full h-20 bg-ctp-surface1 rounded-2xl mb-2 flex flex-row justify-around items-center cursor-pointer hover:bg-ctp-surface2/50 base-transition">
